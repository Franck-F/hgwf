...
const TEXTES = {
  fr: {
    ...
    seoTitre: 'Nos services · HGWF Cargo',
    seoDescription:
  ...
  en: {
    ...
    seoTitre: 'Our services · HGWF Cargo',
    seoDescription:
    ...
    <main>
      ...
      {fiches.length > 0 && (
        <section className="revele mx-auto max-w-[860px] px-5 sm:px-8 pt-16 pb-4">
          <span className="text-xs font-medium tracking-[0.32em] text-encre-douce uppercase">{t.fiches}</span>
