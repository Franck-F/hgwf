 ...
 * restant la référence de contenu.
 *
...
const DOCUMENTS = [
  {
    ...
    sections: [
      section('Responsable du traitement', 'responsable', [
        ...
        'Pour toute question relative à vos données : contact@hgwf-cargo.fr.',
      ]),
      ...
      section('Transfert hors Union européenne', 'transferts', [
        ...
        'Vous pouvez obtenir communication de ces garanties en nous écrivant à contact@hgwf-cargo.fr.',
      ]),
      section('Vos droits', 'vos-droits', [
        ...
        'Pour les exercer, écrivez à contact@hgwf-cargo.fr en précisant votre demande. Nous répondons dans un délai d’un mois, qui peut être prolongé de deux mois si la demande est complexe — nous vous en informerions alors.',
  ...
  },
  {
    ...
    sections: [
      ...
      section('Devis et commande', 'devis', [
        ...
        'Sauf indication expresse au devis, ne sont pas compris :',
  ...
  },
  {
    ...
    sections: [
      section('Publisher', 'editeur', [
        'HGWF CARGO, société par actions simplifiée (a French simplified joint-stock company).',
        'Registered office: avenue Faidherbe, 93110 Rosny-sous-Bois, France.',
        'Logistics address: 10 rue Diderot, 93110 Rosny-sous-Bois.',
        'Email: contact@hgwf-cargo.fr — Phone: +33 6 27 05 69 34.',
      ]),
      section('Company registration', 'immatriculation', [
        ...
        'Intra-Community VAT number: FR18940048051.',
        'Business activity code (code APE): 49.41B — road freight transport.',
      ]),
      section('Publication director', 'direction', [
        'Publication director: Marie Rioltha Bagassien, President.',
      ]),
      ...
      section('Personal data', 'donnees-personnelles', [
        'The processing of data collected on this site is described in our privacy policy.',
      ]),
    ],
  },
  {
    ...
    sections: [
      section('Data controller', 'responsable', [
        ...
        'For any question relating to your data: contact@hgwf-cargo.fr.',
      ]),
      ...
      section('Transfers outside the European Union', 'transferts', [
        ...
        'You can request a copy of these safeguards by writing to contact@hgwf-cargo.fr.',
      ]),
      section('Your rights', 'vos-droits', [
        ...
        'To exercise these rights, write to contact@hgwf-cargo.fr specifying your request. We respond within one month, which may be extended by two months if the request is complex — we would inform you of this.',
        'If our response does not satisfy you, you may contact the Commission nationale de l’informatique et des libertés (CNIL), the French supervisory authority, at 3 place de Fontenoy, TSA 80715, 75334 Paris Cedex 07, or lodge a complaint at cnil.fr.',
      ]),
      section('Cookies', 'cookies', [
